...
import os
app = Flask(__name__)
funcList = [fill_empty_with_nan,drop_missing_data,replace_missing_data,remove_outliers,normalize,delete_constant_columns,combine_first_last_name,drop_useless_columns, check_if_dateTime,one_hot_encode,]
